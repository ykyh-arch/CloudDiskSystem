package uetec.filesystem.util.file_system_manager;
...
import uetec.filesystem.server.util.FileNodeUtil;
...
/**
 * 
 * <h2>uetec-file-system文件系统管理器</h2>
 * <p>
 ...
 * （可能会有一定的耗时）。
 * 每次使用前都请手动调用uetec.filesystem.server.util.FileNodeUtil.initNodeTableToDataBase()方法以确保节点链接最新。
 * </p>
 * 
 * @author 要么出众，要么出局
 * @version 1.0
...
public class FileSystemManager {
	 ...
	 * 
	 * @author 要么出众，要么出局
	 * @return uetec.filesystem.util.file_system_manager.FileSystemManager 唯一实例
	 */
	 ...
	 * </p>
	 * 
	 * @see uetec.filesystem.util.file_system_manager.pojo.FolderView
	 * @author 要么出众，要么出局
	 * @param folderId
	 *            java.lang.String 文件夹ID
	 * @return uetec.filesystem.util.file_system_manager.pojo.FolderView 指定的文件夹视图
	 * @throws SQLException
	 *             获取失败
	 */
	 ...
	 * @return java.util.List<uetec.filesystem.server.model.Folder> 文件夹对象列表，如果没有结果则长度为0
	 * @throws SQLException
	 *             查询失败
	 */
