 ...
 * <h2>文件节点初始化工具</h2>
 * <p>
 * 该工具负责初始化uetec-file-system文件系统的文件节点，其会在数据库内建立文件节点相关的表（如果不存在）并提供该数据库的链接对象。
 * 该类无需生成实例，全部方法均为静态的。
 * </p>
 * 
 * @author 要么出众，要么出局
...
public class FileNodeUtil {
	 ...
	 * @author 要么出众，要么出局
	 * @param folder
	 *            uetec.filesystem.server.model.Folder 原始文件夹
	 * @param parentfolder
	 ...
	 * @author 要么出众，要么出局
	 * @param n
	 *            uetec.filesystem.server.model.Node 要重命名的文件节点
	 * @param folder
